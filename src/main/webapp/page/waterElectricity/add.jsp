...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/index.jsp">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/jscss/admin/design/">水电管理</a><span class="crumb-step">&gt;</span><span>新增水电</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="/waterElectricity_action?action=add" method="get" id="myform" name="myform">
                    <table class="insert-tab" width="100%">
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="common-text required"  name="waterNum" size="50" value="" type="text">
                            </td>
                        </tr>
                        <tr>
                            <th><i class="require-red">*</i>水费：</th>
                            <td>
                                <input class="common-text required"  name="waterCost" size="50" value="" type="text">
                            </td>
                        </tr>
                        <tr>
                            <th><i class="require-red">*</i>用电量：</th>
                            <td>
                                <input class="common-text required" name="electricityNum" size="50" value="" type="text">
                            </td>
                        </tr>
                        <tr>
                            <th><i class="require-red">*</i>电费：</th>
                            <td>
                                <input class="common-text required" name="electricityCost" size="50" value="" type="text">
                            </td>
                        </tr>
                        <tr>
                            <th></th>
