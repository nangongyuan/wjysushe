    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="index.jsp">首页</a><span
                    class="crumb-step">&gt;</span><span class="crumb-name">公寓管理</span></div>
        </div>
        <div class="search-wrap">
            <div class="search-content">
                <form action="/apartment_action" method="get">
            ...
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="/apartment_action?action=add"><i class="icon-font"></i>新增公寓</a>
                    </div>
                </div>
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <%
                            List<Apartment> apartmentList = (List<Apartment>) request.getAttribute("list");
                            for (Apartment item : apartmentList) {
                        %>
                        <tr>
                            <td><%=item.getId()%>
                            </td>
                            <td><%=item.getManagerName()%>
                            </td>
                            <td><%=item.getName()%>
                            </td>
                            ...
                            <td>
                                <a class="link-update" href="/apartment_action?action=edit&id=<%=item.getId()%>">修改</a>
                                <a class="link-del" href="/apartment_action?action=delete&id=<%=item.getId()%>"
