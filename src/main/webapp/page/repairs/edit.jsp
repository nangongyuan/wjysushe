...
<%@ page import="com.wjysushe.bean.Repairs" %>
...
<%
    Repairs repairs = (Repairs) request.getAttribute("repairs");
%>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/jscss/admin/design/">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/jscss/admin/design/">报修管理</a><span class="crumb-step">&gt;</span><span>编辑报修</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="/repairs_action" method="get" id="myform" name="myform" >
                    <table class="insert-tab" width="100%">
                        <tbody><tr>
                            ...
                            <td>
                                <select name="dormitoryId" id="catid" class="required">
                                    ...
                                    %>
                                    <option value="<%=item.getId()%>" <%=repairs.getDormitoryId()==item.getId()?"selected":""%>><%=item.getApartmentName()+"-"+item.getName()%></option>
                                    <%
                                        }
                                    %>
                                </select>
                        ...
                        <tr>
                            ...
                            <td>
                                <div><%=repairs.getExplanation()%></div>
                            </td>
                        </tr>
                        <tr>
                            <th><i class="require-red">*</i>回复：</th>
                            <td>
                                <textarea name="reply" class="common-textarea"  cols="30" style="width: 98%;" rows="10"></textarea>
                                <input name="explanation" value="<%=repairs.getExplanation()%>" type="hidden">
                            </td>
                        </tr>
                        <tr>
                            <th></th>
                            <td>
                                <input name="id" value="<%=repairs.getId()%>" type="hidden">
                                <input name="userId" value="<%=repairs.getUserId()%>" type="hidden">
