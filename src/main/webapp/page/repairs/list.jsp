    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="index.jsp">首页</a><span
                    class="crumb-step">&gt;</span><span class="crumb-name">报修管理</span></div>
        </div>
        <div class="search-wrap">
            <div class="search-content">
                <form action="/repairs_action" method="get">
            ...
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="/repairs_action?action=add"><i class="icon-font"></i>新增报修</a>
                    </div>
                </div>
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <%
                            List<Repairs> repairsList = (List<Repairs>) request.getAttribute("list");
                            for (Repairs item : repairsList) {
                        %>
                        <tr>
                            <td><%=item.getId()%>
                            </td>
                            ...
                            <td><%=item.getExplanation()%>
                            </td>
                            <td><%=item.getReply()==null?"":item.getReply()%>
                            </td>
                            <td><%=item.getStatus()==1?"未回复":"已回复"%>
                            </td>
                            ...
                            %>
                                <td>
                                    <a class="link-update" href="/repairs_action?action=edit&id=<%=item.getId()%>">回复</a>
                                    <a class="link-del" href="/repairs_action?action=delete&id=<%=item.getId()%>"
